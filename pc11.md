...
2. [<i class="fa-solid fa-divide"></i> Rationals](/pc11/ratio.html) ![Static Badge](https://img.shields.io/badge/NoMD_ZM_Compliance-Compliant-green?logo=adguard)
3. [<i class="fa-solid fa-square-root-variable"></i> Radicals](/pc11/radi.html)
4. [<i class="fa-solid fa-calculator"></i> Trigonometry](unav.md)
